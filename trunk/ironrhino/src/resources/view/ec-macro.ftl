...
<#macro ecmiddle>
<td class="nosort"  width="200px" >Action</td>
	</tr>
	</thead>
	<tbody id="ec_table_body" >
</#macro>
<#macro ectbodytrstart recordKey,odd>
<tr class="${odd?string("odd","even")}"  onclick="ECSideUtil.selectRow('ec',this);"  onmouseover="ECSideUtil.lightRow('ec',this);"  onmouseout="ECSideUtil.unlightRow('ec',this);"    recordKey="${recordKey}" >
		<td width="22px"><input type="checkbox"  name="deleteFlag"  value="1"  class="checkbox"/></td>
</#macro>
<#macro ectbodytd cellName,value,cellEdit="",cellEditTemplate="ec_edit_template_input",click="ondblclick">
<td <#if cellEdit!="">${click}="ECSideUtil.editCell(this,'${cellEdit}','${cellEditTemplate}')"</#if>  cellName="${cellName}" >${value}</td>
</#macro>
<#macro ectbodytrend recordKey>
<td class="include_if_edited"  width="200px"  cellName="action"   >
