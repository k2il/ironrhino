 ...
 */
package org.ironrhino.core.ext.openflashchart.model.elements;

import java.io.Serializable;
import java.util.ArrayList;
import java.util.List;

import org.ironrhino.core.ext.openflashchart.model.elements.BarChart.Bar;
import org.ironrhino.core.ext.openflashchart.model.elements.LineChart.Dot;
import org.ironrhino.core.ext.openflashchart.model.elements.PieChart.Slice;
				...
				if (obj instanceof Number) {
					...
					max = Math.max(max,
							((Slice) obj).getValue() != null ? ((Slice) obj)
									.getValue().doubleValue() : 0);
				} else if (obj instanceof org.ironrhino.core.ext.openflashchart.model.elements.HorizontalBarChart.Bar) {
					max = Math
							.max(
									max,
									((org.ironrhino.core.ext.openflashchart.model.elements.HorizontalBarChart.Bar) obj)
											.getLeft() != null ? ((org.ironrhino.core.ext.openflashchart.model.elements.HorizontalBarChart.Bar) obj)
											.getLeft().doubleValue()
											: 0);
					max = Math
							.max(
									max,
									((org.ironrhino.core.ext.openflashchart.model.elements.HorizontalBarChart.Bar) obj)
											.getRight() != null ? ((org.ironrhino.core.ext.openflashchart.model.elements.HorizontalBarChart.Bar) obj)
