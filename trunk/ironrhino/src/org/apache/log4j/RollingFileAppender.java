...
public class RollingFileAppender extends FileAppender {
  ...
  */
  public
  RollingFileAppender(Layout layout, String filename, String encoding, boolean append)
                                      throws IOException {
    super(layout, filename, encoding, append);
  }
  ...
  /**
    ...
    <p>The file will be appended to.  */
  public
  RollingFileAppender(Layout layout, String filename, String encoding) throws IOException {
    super(layout, filename, encoding);
  }
