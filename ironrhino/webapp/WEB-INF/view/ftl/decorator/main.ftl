...
<script type="text/javascript" src="<@uri value="/assets/scripts/app.product.js"/>"></script>
</#if>
...
<div id="wrapper">
<div id="header">
<div id="logo"><a href="<@uri value="/"/>"><img src="<@uri value="/assets/images/logo.gif"/>" alt="返回首页" /></a></div>
<div id="menu">
<ul class="nav">
	<@authorize ifNotGranted="ROLE_BUILTIN_USER">
		<li><a id="login_link" href="<@uri value="/login"/>">登录</a></li>
		<li><a href="<@uri value="/signup"/>">注册</a></li>
	</@authorize>
	<@authorize ifAnyGranted="ROLE_BUILTIN_USER">
		<li><a>${authentication('principal.friendlyName')}</a></li>
		<li><a href="<@uri value="/account/manage"/>">账户设置</a></li>
		<li><a href="<@uri value="/account/order"/>">我的订单</a></li>
		<li><a href="<@uri value="/account/favorite"/>">我的收藏</a></li>
		<li><a href="<@uri value="/logout"/>">注销</a></li>
	</@authorize>
	<li><a href="<@uri value="/product"/>">产品列表</a></li>
	<li><a href="<@uri value="/product/random"/>">随便看看</a></li>
	<li><a href="<@uri value="/cart"/>">购物车</a></li>
	<li class="last"><a href="<@uri value="/"/>" id="root">返回首页</a></li>
</ul>
</div>
<div id="search">
<form id="search_form" action="<@uri value="/search"/>" method="get">
<span><input id="q" type="text" name="q" size="30" maxlength="256" class="autocomplete_off" value="${request.getParameter('q')!}" /></span>
<div id="q_update"
...
<ul class="footer">
	<li><a href="<@uri value="/feedback"/>">问题反馈</a></li>
	<li><a href="<@uri value="/about.html"/>">关于我们</a></li>
	<li><a href="<@uri value="/contact.html"/>">联系我们</a></li>
</ul>
</div>
</div>
</div>
