...
public final class GsonBuilder {
  ...
  private AnnotationBasedExclusionStrategy annotationBasedExclusionStrategy;
  ...
  /**
   * register ExclusionStrategy 
   *
   * @param exclusionStrategies
   * {@link com.google.gson.ExclusionStrategy} class.
   * @return a reference to this {@code GsonBuilder} object to fulfill the "Builder" pattern
   */
  public GsonBuilder registerExclusionStrategy(ExclusionStrategy... exclusionStrategies) {
    strategies.addAll(Arrays.asList(exclusionStrategies));
    return this;
  }
  ...
  /**
   * Configures Gson to excludes all class fields that have the specified annotations. 
   *
   * @param annotationClasses annotation classes on the field.
   * {@link java.lang.annotation.Annotation} class.
   * @return a reference to this {@code GsonBuilder} object to fulfill the "Builder" pattern
   */
  public GsonBuilder excludeFieldsWithAnnotations(Class<?extends Annotation>...annotationClasses) {
    boolean skipSynthetics = true;
    annotationBasedExclusionStrategy = new AnnotationBasedExclusionStrategy(skipSynthetics, annotationClasses);
    return this;
  }
  ...
  public Gson create() {
    ...
    if(annotationBasedExclusionStrategy != null)
    	strategies.add(annotationBasedExclusionStrategy);
