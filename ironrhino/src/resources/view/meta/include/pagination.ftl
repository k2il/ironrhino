...
<ul class="pager">
  <li class="previous<#if resultPage.first> disabled</#if>">
    ...
    <#else>
    <a href="${resultPage.renderUrl(resultPage.previousPage)}"<#list dynamicAttributes?keys as attr><#if attr=='dynamicAttributes'><#list dynamicAttributes['dynamicAttributes']?keys as attr> ${attr}="${dynamicAttributes['dynamicAttributes'][attr]?html}"</#list><#else> ${attr}="${dynamicAttributes[attr]?html}"</#if></#list>>&larr; ${action.getText('previouspage')}</a>
    </#if>
  </li>
  <li class="next<#if resultPage.last> disabled</#if>">
    ...
    <#else>
    <a href="${resultPage.renderUrl(resultPage.nextPage)}"<#list dynamicAttributes?keys as attr><#if attr=='dynamicAttributes'><#list dynamicAttributes['dynamicAttributes']?keys as attr> ${attr}="${dynamicAttributes['dynamicAttributes'][attr]?html}"</#list><#else> ${attr}="${dynamicAttributes[attr]?html}"</#if></#list>>${action.getText('nextpage')} &rarr;</a>
    </#if>
  </li>
</ul>
<#else>
...
<li<#if index==resultPage.pageNo> class="active"</#if>><a href="${resultPage.renderUrl(index)}"<#list dynamicAttributes?keys as attr><#if attr=='dynamicAttributes'><#list dynamicAttributes['dynamicAttributes']?keys as attr> ${attr}="${dynamicAttributes['dynamicAttributes'][attr]?html}"</#list><#else> ${attr}="${dynamicAttributes[attr]?html}"</#if></#list>>${index}</a></li>
</#list>
<#else>
...
<li><a href="${resultPage.renderUrl(index)}"<#list dynamicAttributes?keys as attr><#if attr=='dynamicAttributes'><#list dynamicAttributes['dynamicAttributes']?keys as attr> ${attr}="${dynamicAttributes['dynamicAttributes'][attr]?html}"</#list><#else> ${attr}="${dynamicAttributes[attr]?html}"</#if></#list>>${index}</a></li>
</#list>
...
<#else>
<li><a href="${resultPage.renderUrl(resultPage.nextPage)}" title="${action.getText('nextpage')}"<#list dynamicAttributes?keys as attr><#if attr=='dynamicAttributes'><#list dynamicAttributes['dynamicAttributes']?keys as attr> ${attr}="${dynamicAttributes['dynamicAttributes'][attr]?html}"</#list><#else> ${attr}="${dynamicAttributes[attr]?html}"</#if></#list>>&gt;</a></li>
<li><a href="${resultPage.renderUrl(resultPage.totalPage)}" title="${action.getText('lastpage')}"<#list dynamicAttributes?keys as attr><#if attr=='dynamicAttributes'><#list dynamicAttributes['dynamicAttributes']?keys as attr> ${attr}="${dynamicAttributes['dynamicAttributes'][attr]?html}"</#list><#else> ${attr}="${dynamicAttributes[attr]?html}"</#if></#list>>&gt;&gt;</a></li>
</#if>
</ul>
</div>
</#if>
