...
<form id="daterange" action="<@url value="${actionBaseUrl}/chart"/>" method="get" class="ajax view form-inline nodirty" data-replacement="c"  style="margin-left:10px;">
...
<div id="chart" class="chart" data-url="<@url value="${dataurl}"/>" style="width:100%; height:600px;" data-interval="${Parameters.interval?default('60000')}" data-quiet="true">
