 ...
 * ServletOutputStream, however the destination can be changed at any point. The
 * destination can be passed in using a factory, so it will not be created until
