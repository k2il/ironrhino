...
public class FileAppender extends WriterAppender {
  ...
  */
  public
  FileAppender(Layout layout, String filename, String encoding, boolean append, boolean bufferedIO,
	       int bufferSize) throws IOException {
    this.layout = layout;
  ...
  */
  public
  FileAppender(Layout layout, String filename, String encoding, boolean append)
                                                             throws IOException {
    this.layout = layout;
    this.encoding = encoding;
    this.setFile(filename, append, false, bufferSize);
  ...
  /**
    ...
    <p>The file will be appended to.  */
  public
  FileAppender(Layout layout, String filename, String encoding) throws IOException {
    this(layout, filename, encoding,true);
  }
