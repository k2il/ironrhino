...
public class FreemarkerResult extends StrutsResultSupport {
	...
	protected transient ObjectWrapper wrapper;
	protected transient FreemarkerManager freemarkerManager;
	...
	private static final String PARENT_TEMPLATE_WRITER = FreemarkerResult.class
			.getName()
			+ ".parentWriter";
